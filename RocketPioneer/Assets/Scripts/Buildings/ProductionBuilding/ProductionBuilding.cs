...
namespace Buildings.ProductionBuilding
{
    public class ProductionBuilding : BuildingBase
    {
        ...
        public GameObject indicatorForInput;
        public GameObject productionAnimationTween;
        ...
        public bool CanCraft()
        {
            ...
            if (_recipe.OutputItem == ItemType.Trash)
            {
                return true;
            }
